...
public:
	...
	static void LoadImageFirst(ImageLoadData& _Handle);
private:
	...
	bool m_LoadImageFinished = false;
	bool m_LoadSoundFinished = false;
	bool m_LoadModelFinished = false;
